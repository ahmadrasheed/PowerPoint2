...
namespace PowerPoint
{
    public partial class MainForm : Form
    {
        ...
        private void MainForm_Load(object sender, EventArgs e)
        {
            ...
            wordTabControl.TransitionsButton.Click += new EventHandler(this.TransitionButton_Click);
        ...
        {
            //MessageBox.Show("homeButton_clicked");
        ...
        {
           // MessageBox.Show("InsertButton_clicked");
            if (addedControlType != CTRLTypes.InsertType)
            {
                wordTabControl.tabPanel.Controls.Clear();


                InsertControl1 insertCtrl = new InsertControl1();
                insertCtrl.Location = new Point(1, 1);
                insertCtrl.Anchor = AnchorStyles.Top | AnchorStyles.Left | AnchorStyles.Right | AnchorStyles.Bottom;
                wordTabControl.tabPanel.Controls.Add(insertCtrl);
        ...
        {
           // MessageBox.Show("TransitionButton_clicked");
            ...
            if (addedControlType != CTRLTypes.TransitionType)
            {
                ...
                addedControlType = CTRLTypes.TransitionType; 
            }
        ...
        private void boldBtnz_Click(object sender, EventArgs e)
        {
        ...
        {
            //this.editorContainer.richTextBox.Text = "enter text here ..";
            //wordTabControl.HomeButton.Visible = false;
        ...
        private void wordTabControl_MouseClick(object sender, MouseEventArgs e)
        {
            //MessageBox.Show("clicked pressed");
        }
        ...
        private void wordTabControl_Paint(object sender, PaintEventArgs e)
        {
            //hey ahmad rasheed important ...
            HomeButton_Click(sender, e);
        }

        private void button2_Click(object sender, EventArgs e)
        {
            //zeroitAnimatorEdit1.Target = uc1;
            //zeroitAnimatorEdit1.TargetHeight = uc1.Height;
            //zeroitAnimatorEdit1.TargetWidth = uc1.Width;
